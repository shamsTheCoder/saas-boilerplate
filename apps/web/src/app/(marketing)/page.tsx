    ...
    <>
      ...
      <section className={s.hero}>
        <div className={s.heroContent}>
          ...
          <p className={s.subtitle}>
            A production-grade monorepo with auth, multi-tenancy, billing, audit
            logs, and a full job queue — wired together so you can focus on your
            actual product.
          </p>
      ...
      <section className={s.features}>
        ...
        <p className={s.sectionSubtitle}>
          Stop reinventing auth and billing. These are the hard parts — they're
          already done.
        </p>
      ...
      <section className={s.stack}>
        ...
        <p className={s.sectionSubtitle}>
          No magic frameworks. Just the most battle-tested tools in the Node.js
          ecosystem.
        </p>
